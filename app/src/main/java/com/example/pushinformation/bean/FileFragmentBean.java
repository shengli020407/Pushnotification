package com.example.pushinformation.bean;

import java.util.List;

public class FileFragmentBean {
    ...
    public static class DataDTO {
        ...
        public List<DataDTO.DataDTO1> getData() {
            return data;
        }

        public void setData(List<DataDTO.DataDTO1> data) {
            this.data = data;
        }
